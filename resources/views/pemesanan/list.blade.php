                                ...
                                @foreach ($orders as $order)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if ($order->status == 0)
                                                <button class="btn btn-primary btn-sm btn-detail" data-toggle="modal" data-target="#modal-detail" data-route="{{ route('detailPemesanan', $order->id) }}">
                                                    <i class="fa fa-eye"></i>
                                                </button>
                                                ...
                                                <form id="cancel-order-{{ $order->id }}" method="POST" action="{{ route('cancelPemesanan', $order->id) }}">
                                                    {{ csrf_field() }}
                                                </form>
                                            @else
                                                <button class="btn btn-primary btn-sm btn-detail" data-toggle="modal" data-target="#modal-detail" data-route="{{ route('detailPemesanan', $order->id) }}">
